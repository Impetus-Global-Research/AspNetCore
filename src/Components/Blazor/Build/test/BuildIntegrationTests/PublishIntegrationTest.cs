...
namespace Microsoft.AspNetCore.Blazor.Build
{
    public class PublishIntegrationTest
    {
        ...
        public async Task Publish_WithDefaultSettings_Works()
        {
            ...
            Assert.FileExists(result, blazorPublishDirectory, "dist", "_framework", "_bin", "Microsoft.AspNetCore.Components.Web.dll"); // Verify dependencies are part of the output.

            // Verify static assets are in the publish directory
            Assert.FileExists(result, blazorPublishDirectory, "dist", "index.html");
            Assert.FileExists(result, blazorPublishDirectory, "dist", "sample-data", "weather.json");
